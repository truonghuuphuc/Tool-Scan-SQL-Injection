...
class NRequests:
    def __init__(self):
        self.header={
            "User-Agent":self.useragent_list(),
            "Referer":self.referer_list()
        }
        self.rq=requests.Session()
    def sendGet(self,url):
        self.reqs=self.rq.get(url,headers=self.header,verify=False)
    def status(self):
        return self.reqs.status_code
    def source(self):
        return self.reqs.text
